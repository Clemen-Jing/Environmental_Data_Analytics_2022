...
```{r}
Highs_F <- c(29, 38, 45, 47, 46, 42, 37, 45, 42)
Lows_F <- c(19, 19, 26, 32, 21, 18, 20, 26, 25)
```
...
```{r}
the_temps <- data.frame(Highs_F, Lows_F, Highs_C, Lows_C)

#or

the_temps <- cbind(Highs_F, Lows_F, Highs_C, Lows_C)
