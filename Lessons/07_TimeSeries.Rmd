...
ggplot(EnoDischarge.complete, aes(x = datetime, y = discharge.mean)) +
  geom_line() +
  labs(x = "", y = expression("Discharge (ft"^3*"/s)"))
...
#or EnoDischarge.late_ts <- ts(EnoDischarge.late[[8]], start = c(1985,1), frequency = 365)
...
#zoo::na.approx: there is a same name function in other package, so remember add zoo::
#this function is to give a value to the NA
