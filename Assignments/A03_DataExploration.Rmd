...
*Locations of tower plots are selected randomly within the 90% flux footprint of the primary andsecondary airsheds (and additional areas in close proximity to the airshed, as necessary to accommodate sufficientspacing between plots).
...
They are all being in the wasp-waisted Apocrita.
They are all considered to be beneficial insects.
